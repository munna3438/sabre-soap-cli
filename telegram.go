...
func buildSeatHoldSuccessMessage(in *BlockInput) string {
	return fmt.Sprintf("✅ Successfully Seat Blocked. \nFrom: %s\nTo: %s\nDate: %s\nBooking Class: %s", in.From, in.To, in.Date, in.BookingClass)
}
